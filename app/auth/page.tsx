...
export default function AuthPage() {
  const { user, signInWithOTP, verifyOTP, signInWithGoogle, signInWithApple, signOut } = useAuth()
  ...
  if (user) return (
    <>
      ...
      <main style={{ maxWidth: '480px', textAlign: 'center', paddingTop: '4rem' }}>
        ...
        <p style={{ color: 'var(--muted)', marginBottom: '2rem' }}>You're logged in as {user.email || user.phone || 'User'}.</p>
  ...
  return (
    <>
      ...
      <main style={{ maxWidth: '480px', paddingTop: '4rem' }}>
        ...
        <p style={{ color: 'var(--muted)', marginBottom: '2rem' }}>Sign in to track your rides and save addresses.</p>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
          ...
          <span style={{ color: 'var(--muted)', fontSize: '0.875rem' }}>or sign in with phone</span>
          <div style={{ flex: 1, height: '1px', background: 'var(--border)' }}></div>
        </div>
